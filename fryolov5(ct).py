...
Original file is located at
    https://colab.research.google.com/drive/1rEv2sAkIakO8KEzgnDjIDT0cWCOv4NoK
"""
...
if not os.path.exists('train'):
    !curl -L "https://universe.roboflow.com/ds/V4JZ888Ake?key=3fkAoCd9hh" > roboflow.zip; unzip roboflow.zip; rm roboflow.zip
